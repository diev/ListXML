...
<xsl:template match="/">
  ...
  <xsl:apply-templates select="ed:ED283"/>
  <xsl:apply-templates select="ed:ED284"/>
  <xsl:apply-templates select="ed:ED285"/>
...
<!-- =============================================================================================================
	Пакет ЭС для операции с наличными деньгами
================================================================================================================== -->
<xsl:template match="ed:PacketCash">
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:text>ПАКЕТ ЭС ДЛЯ ОПЕРАЦИЙ С НАЛИЧНЫМИ ДЕНЬГАМИ</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:text>(НЕ РЕАЛИЗОВАНО ПОКА)</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:apply-templates/>
</xsl:template>
...
<xsl:template match="ed:ED280">
	...
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:value-of select="concat(position()-$modif_pos,'.  ')"/>
	<xsl:text>Извещение о получении ЭС &#13;&#10;</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:text>(НЕ РЕАЛИЗОВАНО ПОКА)</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
</xsl:template>
...
<!--  ED283  -->
<xsl:template match="ed:ED283">
	<xsl:text>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:value-of select="concat(position()-$modif_pos,'.  ')"/>
	<xsl:text>Заявка на получение/сдачу наличных денег Банка России, &#13;&#10;</xsl:text>
  <xsl:text>заявка на выдачу/прием наличных денег Банка России &#13;&#10;</xsl:text>  
  <xsl:text>в соответствии с предоставленным Банком России разрешением &#13;&#10;</xsl:text>    
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:text>(НЕ РЕАЛИЗОВАНО ПОКА)</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
</xsl:template>
...
<!--  ED284  -->
<xsl:template match="ed:ED284">
	<xsl:text>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:value-of select="concat(position()-$modif_pos,'.  ')"/>
	<xsl:text>Разрешение на совершение операций с наличными деньгами Банка России &#13;&#10;</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:text>(НЕ РЕАЛИЗОВАНО ПОКА)</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
</xsl:template>
...
<!--  ED285  -->
<xsl:template match="ed:ED285">
	<xsl:text>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:value-of select="concat(position()-$modif_pos,'.  ')"/>
	<xsl:text>Сообщение о проведенной операции с наличными деньгами Банка России &#13;&#10;</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
	<xsl:text>(НЕ РЕАЛИЗОВАНО ПОКА)</xsl:text>
	<xsl:text>&#13;&#10;</xsl:text>
</xsl:template>
...
<msxsl:script language="C#" implements-prefix="usr">
<![CDATA[
	// Преобразование даты из формата ГГГГ-ММ-ДД в ДД.ММ.ГГГГ
	public string fDate(string s)
  {
	...
	// Преобразование суммы из копеек в формат "рубли.копейки"
	public string fSum(string s)
  {
    long v = long.Parse(s);
		return string.Format("{0:N0}.{1:00}", v / 100, Math.Abs(v) % 100);
	}
]]>
</msxsl:script>
</xsl:stylesheet>
