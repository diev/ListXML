...
namespace Lib
{
    public static class BaseConvert
    {
        ...
        public static int FromBase36(string toDecode)
        {
            int result = 0;
        ...
        public static string ToBase36(int toEncode, int padleft = 0)
        {
        ...
        public static string FromBase64(string toDecode, int enc = 1251)
        {
        ...
        {
            return string.Format("{0:N0}.{1:00}", sumInKop / 100, Math.Abs(sumInKop) % 100);
        }
        #endregion
